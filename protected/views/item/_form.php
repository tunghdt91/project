    ...
    <?php 
        foreach ($params as $param) {
            echo "<tr>";
                ...
                echo "<td>";
                echo CHtml::textField("{$item->id}[{$param->id}][value1]", $param->data ? $param->data->value1 : '');
                echo "</td>";
                echo "<td>";
                echo CHtml::textField("{$item->id}[{$param->id}][value2]", $param->data ? $param->data->value2 : '');
                echo "</td>";
                echo "<td>";
                echo CHtml::textField("{$item->id}[{$param->id}][value3]", $param->data ? $param->data->value3 : '');
                echo "</td>";
            echo "</tr>";
        }
    ?>
